...
Game.prototype.createUI = function() {
    ...
    this.canvasUI.addElement(new CanvasUIElement({
        ...
        renderFunc: function(ctx, button, cursorOn, pressedExtent) {
    ...
    var addLocationUI = function(location) {
        var button = new CanvasUIElement({
            ...
            renderFunc: function(ctx, button, cursorOn, pressedExtent) {
                location.render(ctx, button, cursorOn, pressedExtent);
            },
            clickCallback: function() {
        ...
        for (var i = 0; i < faction.researchSlots; ++i) {
            var button = (function(j) {
                return new CanvasUIElement({
                    ...
                    active: false,
                    renderFunc: function(ctx, button, cursorOn, pressedExtent) {
                        faction.renderResearchButton(ctx, button, cursorOn, pressedExtent, j);
                    },
                    clickCallback: function() {
        ...
        for (var i = 0; i < Unit.Types.length; ++i) {
            var button = (function(j) {
                return new CanvasUIElement({
                    ...
                    draggable: true,
                    renderFunc: function(ctx, button, cursorOn, pressedExtent) {
                        faction.renderReserveButton(ctx, button, cursorOn, pressedExtent, j);
                    },
                    clickCallback: function() {
        ...
        for (var i = 0; i < faction.researchSlots; ++i) {
            var button = (function(j) {
                return new CanvasUIElement({
                    ...
                    draggable: false,
                    renderFunc: function(ctx, button, cursorOn, pressedExtent) {
                        faction.renderIntelButton(ctx, button, cursorOn, pressedExtent, j);
                    },
                    clickCallback: function() {
